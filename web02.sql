...
CREATE TABLE `news` (
  ...
  `type` int(1) UNSIGNED NOT NULL COMMENT '分類',
  `good` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '案讚',
...
(6, '問題二：二手菸沒有安全劑量，只要有暴露，就會有危險，請問它會造成身體上哪些危害?', 0, 1),
